...
***
*项目工程在：[transaction-2pc-narayana-xa-raw-jdbc-example](https://github.com/lw1243925457/JAVA-000/tree/main/homework/shardingSphere-jdbc-example/transaction-example/transaction-2pc-narayana-xa-raw-jdbc-example)*

## 代码简介
&ensp;&ensp;&ensp;&ensp;基于ShardingSphere的 Narayana XA实现一个简单的分布式事务应用demo
